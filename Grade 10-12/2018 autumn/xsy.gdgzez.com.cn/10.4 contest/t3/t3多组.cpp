...
int main(){
	...
	while(T--){
  	  	...
  	  	memset(dep,0,sizeof(dep));memset(st,0,sizeof(st));memset(fa,0,sizeof(fa));
  	  	memset(back,0,sizeof(back));memset(dfn,0,sizeof(dfn));memset(lim,0,sizeof(lim));cntn=0;
  	  	memset(a,0,sizeof(a));memset(lazy,0,sizeof(lazy));
  	  	memset(ch,0,sizeof(ch));memset(rt,0,sizeof(rt));memset(fa,0,sizeof(fa));
